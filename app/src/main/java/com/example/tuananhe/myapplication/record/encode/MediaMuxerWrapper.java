...
public class MediaMuxerWrapper {
     ...
     * @throws IOException
     */
    public MediaMuxerWrapper(final String root, final String _ext) throws IOException {
        try {
            File outputFile = new File(root, "Screen-record-" + Long.toHexString(System.currentTimeMillis()) + _ext);

            mOutputPath = outputFile.getCanonicalPath();
            Log.d(TAG, "MediaMuxerWrapper: " + outputFile);
